...
void generate_fully_coherent_circuit_test(size_t vertex_number) {
    generate_fully_coherent_subcircuits_test(vertex_number, 1);
}

void generate_consistent_circuit_test(size_t vertex_first, size_t vertex_last) {
    std::stringstream circuit_, answer_;
    circuit_ << vertex_first << " -- " << vertex_last << ", 1.0; " << vertex_last - vertex_first + 1 << "V; ";
    answer_ << vertex_first << " -- " << vertex_last << ": 1 A;\n";
    for (size_t outcoming = vertex_first; outcoming < vertex_last; outcoming++) {
        circuit_ << outcoming << " -- " << outcoming + 1 << ", 1.0; ";
...
TEST(FullyConnectedCircuitTest, FullyConnected10Test) { generate_fully_coherent_circuit_test(10); }
TEST(FullyConnectedCircuitTest, FullyConnected20Test) { generate_fully_coherent_circuit_test(20); }
TEST(FullyConnectedCircuitTest, FullyConnected30Test) { generate_fully_coherent_circuit_test(30); }
TEST(FullyConnectedCircuitTest, FullyConnected40Test) { generate_fully_coherent_circuit_test(40); }
TEST(FullyConnectedCircuitTest, FullyConnected50Test) { generate_fully_coherent_circuit_test(50); }
TEST(FullyConnectedCircuitTest, FullyConnected60Test) { generate_fully_coherent_circuit_test(60); }
TEST(FullyConnectedCircuitTest, FullyConnected70Test) { generate_fully_coherent_circuit_test(70); }
TEST(FullyConnectedCircuitTest, FullyConnected80Test) { generate_fully_coherent_circuit_test(80); }
TEST(FullyConnectedCircuitTest, FullyConnected90Test) { generate_fully_coherent_circuit_test(90); }
TEST(FullyConnectedCircuitTest, FullyConnected100Test) { generate_fully_coherent_circuit_test(100); }


TEST(ConsistentCircuitTest, Consistent10Test) { generate_consistent_circuit_test(1, 10); }
TEST(ConsistentCircuitTest, Consistent20Test) { generate_consistent_circuit_test(1, 20); }
TEST(ConsistentCircuitTest, Consistent30Test) { generate_consistent_circuit_test(1, 30); }
TEST(ConsistentCircuitTest, Consistent40Test) { generate_consistent_circuit_test(1, 40); }
TEST(ConsistentCircuitTest, Consistent50Test) { generate_consistent_circuit_test(1, 50); }
TEST(ConsistentCircuitTest, Consistent60Test) { generate_consistent_circuit_test(1, 60); }
TEST(ConsistentCircuitTest, Consistent70Test) { generate_consistent_circuit_test(1, 70); }
TEST(ConsistentCircuitTest, Consistent80Test) { generate_consistent_circuit_test(1, 80); }
TEST(ConsistentCircuitTest, Consistent90Test) { generate_consistent_circuit_test(1, 90); }
TEST(ConsistentCircuitTest, Consistent100Test) { generate_consistent_circuit_test(1, 100); }
